...
#
#     PragstudioLiveviewCode.Repo.insert!(%PragstudioLiveviewCode.SomeSchema{})
#
...
alias PragstudioLiveviewCode.GitRepos.GitRepo
...
%Store{
  name: "Downtown Mirassol",
  street: "Ennio Martelli",
  phone_number: "17 99632-5559",
  city: "Mirassol, SP",
  zip: "15133348",
  open: true,
  hours: "3am - 11pm M-F"
